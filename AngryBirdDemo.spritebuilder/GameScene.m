...
-(void)dieSeal:(SKNode*)node{
    /* Seal death*/
    
    /* Load our particle effect */
    SKEmitterNode *particles = [SKEmitterNode nodeWithFileNamed: @"SealExplosion"];
    ...
    /* Play SFX */
    SKAction *sealSFX = [SKAction playSoundFileNamed:@"sfx_seal" waitForCompletion: false];
    [self runAction:sealSFX];
    
    /* Create our seal removal action */
    SKAction *sealDeath = [SKAction removeFromParent];
    [node runAction:sealDeath];
}
